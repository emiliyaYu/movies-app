...
const Card = ({ title, date, description, poster, voteAverage, rate, id, getRatedData, genres}) => {
    ...
    return (
            <div className='card'>
               <ReactImageFallback src={`https://image.tmdb.org/t/p/original${poster}`} fallbackImage={fallbackOfImage} className='image'/>
                <div className='info'>
